...
cp $KERNEL_DIR/arch/arm64/boot/Image  $MODULES_DIR/../G3Output/tools
cp $KERNEL_DIR/arch/arm64/boot/dt.img  $MODULES_DIR/../G3Output/tools
...
dropbox_uploader -p upload $MODULES_DIR/../G3Output/$zipfile /
